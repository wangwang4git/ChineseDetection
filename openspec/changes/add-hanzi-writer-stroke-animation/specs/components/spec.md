...
HanziGrid 组件 SHALL 基于 hanzi-writer-miniprogram 实现汉字渲染，支持笔画动画功能，并保持与 RiceGrid 相同的视觉样式（金色边框、白色背景、米字格线条）。仅支持微信小程序环境。

#### Scenario: 小程序环境汉字渲染
- **WHEN** 使用 `<HanziGrid char="向" :size="488" />`
